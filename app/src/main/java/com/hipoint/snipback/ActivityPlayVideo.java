...
//
//                openGallery(snip.getVideoFilePath(),mediaFile);
                saveVideo(snip);
            }
        });
...
//        String[] complexCommand = {"-i",yourAudioPath,"-i",input_share,"-codec","copy","-shortest",String.valueOf(mediaFile)};
        String imagepath="/storage/emulated/0/Download/images.jpeg";
...
//                        File file = new File(outputPath_share);
//                        Intent intent = new Intent(Intent.ACTION_VIEW);
//                        Uri uri = (Uri) FileProvider.getUriForFile(ActivityPlayVideo.this, BuildConfig.APPLICATION_ID + ".provider", file);
...
//                            FFmpegCmd.exec(complexCommandaudio, 0, new OnEditorListener() {
//                                @Override
//                                public void onSuccess() {
//
//                                    runOnUiThread(() -> {
